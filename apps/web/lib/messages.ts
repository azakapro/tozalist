...
const en = {
  ...
  'pricing.pilot.price': '500,000 UZS',
  'pricing.pilot.volume': '10,000 checks',
  'pricing.team.name': 'Team',
  'pricing.team.price': '1,500,000 UZS',
  'pricing.team.volume': '50,000 checks',
  'pricing.api.name': 'API',
  'pricing.api.price': '3,500,000 UZS',
  'pricing.api.volume': '200,000 checks',
...
const uz: Record<MessageKey, string> = {
  ...
  'pricing.pilot.name': 'Pilot',
  'pricing.pilot.price': "500 000 so'm",
  'pricing.pilot.volume': '10 000 tekshiruv',
  'pricing.team.name': 'Team',
  'pricing.team.price': "1 500 000 so'm",
  'pricing.team.volume': '50 000 tekshiruv',
  'pricing.api.name': 'API',
  'pricing.api.price': "3 500 000 so'm",
  'pricing.api.volume': '200 000 tekshiruv',
...
const ru: Record<MessageKey, string> = {
  ...
  'pricing.pilot.name': 'Pilot',
  'pricing.pilot.price': '500 000 сум',
  'pricing.pilot.volume': '10 000 проверок',
  'pricing.team.name': 'Team',
  'pricing.team.price': '1 500 000 сум',
  'pricing.team.volume': '50 000 проверок',
  'pricing.api.name': 'API',
  'pricing.api.price': '3 500 000 сум',
  'pricing.api.volume': '200 000 проверок',
