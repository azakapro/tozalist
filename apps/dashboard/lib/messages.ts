...
const en = {
  ...
  'billing.lastGrant': 'Most recent grant',
  'billing.lowBalance':
    'Low balance: fewer than 10% of your last grant remains. Request an invoice to top up.',
  'billing.mtd.title': 'This month',
  'billing.mtd.consumed': 'Credits used',
  'billing.mtd.batches': 'Batches run',
  'billing.mtd.allowance': 'of the plan allowance',
  'billing.plan.select': 'Compare against plan',
  'billing.invoice.title': 'Request an invoice',
  'billing.invoice.explain':
    'Choose a plan and we will issue an invoice for bank transfer. Credits are granted manually once payment arrives - no card is charged and no payment data is stored.',
  'billing.invoice.button': 'Request invoice',
  'billing.invoice.working': 'Requesting\u2026',
  'billing.invoice.bank': 'Bank transfer instructions',
  'billing.invoice.requested': 'Invoice request recorded.',
  'billing.ledger.title': 'Ledger history',
  'billing.ledger.when': 'When',
  'billing.ledger.reason': 'Type',
  'billing.ledger.delta': 'Credits',
  'billing.ledger.balance': 'Balance',
  'billing.statements.title': 'Monthly statements',
  'billing.statements.none': 'No statements yet. They appear here after each billed month.',
  'billing.statements.download': 'Download',
  'billing.statements.linkNote': 'Links expire after one hour.',
